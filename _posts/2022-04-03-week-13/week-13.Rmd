...
description: |
  Exploring US college sports (data from [tidytuesday project](https://github.com/rfordatascience/tidytuesday/blob/master/data/2022/2022-03-29/readme.md)
author:
  - name: Oumarou Diallo
date: 2022-04-03
preview: sports.jpeg
...
subtitle_main <- "<span style = 'color:black'> - **Overall**, *Combined Track & Field*, *Football*, *Soccer* are the highest level of participation</span><span style = 'color:black'>**(>400,000)**.</span><br><span style = 'color:black'> -  **Soccer**</span><span style = 'color:black'> comes in **top 3** for women and **top 4** for men.</span><br><span style = 'color:black'> - Trends for **Revenues** & **Expenses** are similar accross sports.</span>"
...
```{r}
pp <- plot_1 + 
  inset_element(plot_2, 0.35, 0.01, .95, .4) + # left-bottom-right-top
  inset_element(plot_3, 0.35, 0.401, .95, .75) 
pp
```
